...
const char* ssid = "MyCircuits";
const char* password = "12345678";

#define SD_pin 15 //G16 in my case

bool   SD_present = false; //Controls if the SD card is present or not

String sensorName = "MPU6050"; //Sensor name
...
void loop(void)
{
  ...
  if (mpu.dmpGetCurrentFIFOPacket(fifoBuffer)) { // Get the Latest packet 
          ...
          dataString += ",Quaternion container:";
          dataString += (ypr[0] * 180/M_PI); //Celcius
          dataString += ",";
          dataString += (ypr[1] * 180/M_PI);//%
          dataString += ",";
          dataString += (ypr[2] * 180/M_PI); //Pa
